...
var productList = [Product(name: "Blue grandfather sweater", image: "sweater1", price: 46),
                   ...
                   Product(name: "Beige sweater", image: "sweater6", price: 44),
                   Product(name: "Spruce sweater", image: "sweater7", price: 45),
                   Product(name: "Ocean sweater", image: "sweater8", price: 35),
                   Product(name: "Black carpet", image: "sweater9", price: 49),
                   Product(name: "Candy cane", image: "sweater10", price: 44),
                   Product(name: "Blue sky", image: "sweater11", price: 42),
                   Product(name: "Quiksilver", image: "sweater12", price: 39),
                   Product(name: "Wheat field", image: "sweater13", price: 42),
                   Product(name: "Christmas tree", image: "sweater14", price: 44)]
